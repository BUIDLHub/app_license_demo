...
import styles from "../../Components/Licensor/NewVendor/NewVendor.module.scss";
    ...
    <div className={classNames(["card"], ["shadow"], ["my-2"])}>
      <div className={classNames([styles.card_body])}>
        <div className={classNames([styles.card_div])}>
          <p className={classNames([styles.card_h])}>Marketplace</p>
          <p className={classNames([styles.card_subh], ["mt-1"])}>
            Here's a page
          </p>
          <hr />
          <div className={classNames([styles.center])}>
            Here's where children elements go
          </div>
        </div>
      </div>
    </div>
